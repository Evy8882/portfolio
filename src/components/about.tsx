    ...
    <div className="about-container" id="about">
      ...
      <h1 className="appear">Sobre Mim</h1>
        <div className="appear">
          ...
          conhecimento em aplicações web, desktop e jogos.
          <br />
        <br />
          Estou indo para o último ano do meu curso técnico em <b>Desenvolvimento de Sistemas</b> e já desenvolvi diversos projetos que me ajudaram a aprimorar minhas habilidades.
          <br />
          <br />
